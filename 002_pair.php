...
// $storageEncryptionKeyFromEnv = 'TopSecretPassword';
// $privateKeyFromEnv = '/home/elliotsawyer/Documents/bitpay.pri';
// $publicKeyFromEnv = '/home/elliotsawyer/Documents/bitpay.pub';
// $btcpayServerHostFromEnv = 'testnet.demo.btcpayserver.org';
// $pairingCodeFromEnv = 'm3HRqZT';

$storageEncryptionKeyFromEnv = $_ENV['BTCPAYSERVER_CONF_ENC_PASS'];
$privateKeyFromEnv = $_ENV['BTCPAYSERVER_PRIKEY_LOC'];
$publicKeyFromEnv = $_ENV['BTCPAYSERVER_PUBKEY_LOC'];
$btcpayServerHostFromEnv = $_ENV['BTCPAYSERVER_HOST'];
$pairingCodeFromEnv = $_ENV['BTCPAYSERVER_PAIRING_TOKEN'];

$storageEngine = new \Bitpay\Storage\EncryptedFilesystemStorage($storageEncryptionKeyFromEnv);
$privateKey    = $storageEngine->load($privateKeyFromEnv);
$publicKey     = $storageEngine->load($publicKeyFromEnv);
 ...
 */
$client->setUri($btcpayServerHostFromEnv);
 ...
 */
$pairingCode = $pairingCodeFromEnv;
